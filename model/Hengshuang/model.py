...
from model.Hengshuang.pointnet_util import PointNetFeaturePropagation, PointNetSetAbstraction
from model.Hengshuang.transformer import TransformerBlock
...
class PointTransformerCls(nn.Module):
    ...
    def forward(self, x):
        ...
        return res, points  #points[b,4,512]
